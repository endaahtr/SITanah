					...
					<form action="" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class="icon-object border-slate-300 text-slate-300"><img src="assets/images/bpn.png" alt="bpn.png" width="100"></div>
								<h5 class="content-group">Sistem Informasi Pendaftaran Sertifikasi Pertanahan <small class="display-block">Silahkan Masuk</small></h5>
								<?php
