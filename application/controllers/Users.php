...
class Users extends CI_Controller {
	...
	public function index()
	{
		...
		if(!isset($ceks)) {
			...
			$data['judul_web'] = "Beranda | Sistem Informasi Sertfikasi Pertanahan ";
	...
	public function profile()
	{
		...
		if(!isset($ceks)) {
			...
			$data['judul_web'] 		= "Profile | Sistem Informasi Sertfikasi Pertanahan";
		...
		if(!isset($ceks)) {
			...
			$data['level_users']  = $this->Mcrud->get_level_users();
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Pengguna | Sistem Informasi Sertfikasi Pertanahan";
				}elseif ($aksi == 'd') {
					$p = "pengguna_detail";

					$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
					$data['judul_web'] 	  = "Detail Pengguna | Sistem Informasi Sertfikasi Pertanahan";
				}elseif ($aksi == 'e') {
					$p = "pengguna_edit";

					$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
					$data['judul_web'] 	  = "Edit Pengguna | Sistem Informasi Sertfikasi Pertanahan";
				}elseif ($aksi == 'h') {

					$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
					$data['judul_web'] 	  = "Hapus Pengguna | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['judul_web'] 	  = "Pengguna | Sistem Informasi Sertfikasi Pertanahan";
				}
		...
		if(!isset($ceks)) {
			...
			$data['bagian'] 		  = $this->db->get("tbl_bagian");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Bagian | Sistem Informasi Sertfikasi Pertanahan";
				}elseif ($aksi == 'e') {
					$p = "bagian_edit";
					if ($data['user']->row()->level == 's_admin') {
							redirect('404_content');
					...
					$data['judul_web'] 	  = "Edit Bagian | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['query'] = $this->db->get_where("tbl_bagian", array('id_bagian' => "$id"))->row();
					$data['judul_web'] 	  = "Hapus Bagian | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['judul_web'] 	  = "Bagian | Sistem Informasi Sertfikasi Pertanahan";
				}
		...
		if(!isset($ceks)) {
			...
			$data['ns'] 		  = $this->db->get("tbl_ns");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Nomor Surat | Sistem Informasi Sertfikasi Pertanahan";
				}elseif ($aksi == 'e') {
					$p = "ns_edit";
					if ($data['user']->row()->level == 's_admin') {
							redirect('404_content');
					...
					$data['judul_web'] 	  = "Edit Nomor Surat | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['query'] = $this->db->get_where("tbl_ns", array('id_ns' => "$id", 'id_user' => "$id_user"))->row();
					$data['judul_web'] 	  = "Hapus Nomor Surat | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['judul_web'] 	  = "Nomor surat | Sistem Informasi Sertfikasi Pertanahan";
				}
		...
		if(!isset($ceks)) {
			...
			$data['sm'] 		  = $this->db->get("tbl_sm");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Surat Masuk | Sistem Informasi Sertfikasi Pertanahan";
					$data['data_ns']			= $this->Mcrud->data_ns('sm', "$id_user");
				}elseif ($aksi == 'd') {
					$p = "sm_detail";

					$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id"))->row();
					$data['judul_web'] 	  = "Detail Surat Masuk | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id"))->row();
					$data['judul_web'] 	  = "Edit Surat Masuk | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['judul_web'] 	  = "Hapus Surat Masuk | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['judul_web'] 	  = "Surat Masuk | Sistem Informasi Sertfikasi Pertanahan";
				}
		...
		if(!isset($ceks)) {
			...
			$data['bagian'] 		  = $this->db->get_where("tbl_bagian","id_user='$id_user'")->result();
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Surat Keluar | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['judul_web'] 	  = "Detail Surat Keluar | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['judul_web'] 	  = "Edit Surat Keluar | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['query'] = $this->db->get_where("tbl_sk", array('id_sk' => "$id", 'id_user' => "$id_user"))->row();
					$data['judul_web'] 	  = "Hapus Surat Keluar | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['judul_web'] 	  = "Surat Keluar | Sistem Informasi Sertfikasi Pertanahan";
				}
		...
		if(!isset($ceks)) {
			...
			$data['memo'] 		  = $this->db->get("tbl_memo");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Memo | Sistem Informasi Sertfikasi Pertanahan";
				}elseif ($aksi == 'e') {
					$p = "memo_edit";
					if ($data['user']->row()->level == 's_admin') {
							redirect('404_content');
					...
					$data['judul_web'] 	  = "Edit Memo | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['query'] = $this->db->get_where("tbl_memo", array('id_memo' => "$id", 'id_user' => "$id_user"))->row();
					$data['judul_web'] 	  = "Hapus Memo | Sistem Informasi Sertfikasi Pertanahan";
					...
					$data['judul_web'] 	  = "Memo | Sistem Informasi Sertfikasi Pertanahan";
				}
	...
	public function lap_sk()
	{
		...
		if(!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Keluar | Sistem Informasi Sertfikasi Pertanahan";
			...
			if(!isset($ceks)) {
				redirect('web/login');
						...
						if ($tgl1 != '' AND $tgl2 != '') {
								...
								$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
								$data['judul_web'] = "Data Laporan Surat Keluar | Sistem Informasi Sertfikasi Pertanahan";
								$this->load->view('users/header', $data);
	...
	public function lap_sm()
	{
		...
		if(!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Masuk | Sistem Informasi Sertfikasi Pertanahan";
			...
			if(!isset($ceks)) {
				redirect('web/login');
						...
						if ($tgl1 != '' AND $tgl2 != '') {
								...
								$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
								$data['judul_web'] = "Data Laporan Surat Masuk | Sistem Informasi Sertfikasi Pertanahan";
								$this->load->view('users/header', $data);
